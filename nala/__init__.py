...
if not os.environ.get("_NALA_COMPLETE"):
	# Force English locale for nala-fedora
...
# import apt_pkg  # Replaced with DNF for Fedora
from rich.console import Console

# For Fedora/DNF version, we don't need debian.debian_support
# import debian.debian_support  # isort:skip

# DNF initialization is handled differently
# We don't need to initialize a config like APT does

__version__ = "0.16.0-fedora"
